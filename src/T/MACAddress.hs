...
import TastyPlus ( (≟), assertIsLeft, runTestsP, runTestTree  )
...
import MACAddress    ( MACAddress( MACAddress ), mac )
...
fromYamlTests =
  let fromYAML = first prettyPrintParseException ⊳ Yaml.decodeEither' ∘ toUtf8
   in testGroup "fromYaml"
                ...
                , testCase "testMAC1T_"  $
                    Right testMAC1 @=? fromYAML testMAC1T_
                , testCase "testMAC1T__" $
                    Right testMAC1 @=? fromYAML testMAC1T__
                , testCase "testMAC2T"   $ Right testMAC2 @=? fromYAML testMAC2T
                , testCase "testMAC2T'"  $ Right testMAC2 @=? fromYAML testMAC2T'
                , testCase "testMAC2T_"  $
                    Right testMAC2 @=? fromYAML testMAC2T_
